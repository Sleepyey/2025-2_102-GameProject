...
public class PlayerController : MonoBehaviour
{
    ...
    [Header("커포넌트")]
    public Animator animator;                           // 컨포넌트 하위에 animator 가 존재하기 때문에
    ...
    private bool isGrounded;                            // 땅에 있는지 판병
    ...
    void UpdateAnimator()
    {
        ...
        bool isFalling = !isGrounded && velocity.y < -0.1f;             // 캐릭터가 Y축 속도가ㅓ음수로 넘어가면 떨어지고 있다고 판단
    ...
    void CheckGrounded()
    {
        ...
        isGrounded = controller.isGrounded;                 // 캐릭터 컨트롤러에서 사태 값을 받아온다.
